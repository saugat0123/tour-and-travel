...
export default class orderReciept extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:3000/allConfirm", this.state.config)
      .then((response) => {
        this.setState({ data: response.data.data });

        console.log("CONFIRM DARA:::::::", this.state.data);
      });
  }
  ...
  cancel = (pid) => {
    axios
      .delete(
        "http://localhost:3000/cancelConfirm/" +
                                ...
                                {data.ProductId.map((item) => {
                                  return (
                                    <tr>
                                      ...
                                      <td className="text-right">
                                        {parseInt(item.item.Price) * item.qty}
                                      </td>
                                    </tr>
                                  );
                                })}
