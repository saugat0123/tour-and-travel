...
export default class checkOut extends Component {
    ...
    order = () => {
        ...
        axios.post('http://localhost:3000/confirm', this.state, this.state.config).then((response) => {

            alert("Booking placed")
            axios.delete('http://localhost:3000/deleteBooking', this.state.config).then(function (response) {
            })
                                    ...
                                    return (
                                        <li className="list-group-item d-flex justify-content-between lh-condensed">
                                            ...
                                            <div>
                                                ...
                                                <strong className="text-muted">{"No of Rooms: " + data.qty}</strong>
                                            </div>
