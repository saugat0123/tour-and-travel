...
export default class updateResturant extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:3000/getRest/" + this.state.id)
      .then((response) => {
  ...
  addResturant = (e) => {
    ...
    axios
      .put(
        "http://localhost:3000/upResturant/" + this.state.id,
        data,
        this.state.config
      )
      .then((response) => {
  ...
  deleteFood = (id) => {
    axios
      .delete("http://localhost:3000/deleteFood/" + id + "/" + this.state.id)
      .then((response) => {
        alert("success");
      });
  };
    ...
    return (
      <div>
        <div
          ...
          style={{ border: "solid 0.5px", marginTop: "100px" }}
        >
          <div className="row">
            <div className="col-md-5">
              <img
                src={"http://localhost:3000/images/" + this.state.images}
                style={{ padding: "20px" }}
                width="100%"
                height="100%"
              />
                      ...
                      {user === "Admin" ? (
                        <>
                          <li>
                            <a
                              href="#"
                              onClick={this.deleteFood.bind(this, food._id)}
                            >
                          ...
                          <li>
                            <a href="#">
                              <i
                                class="fa fa-random"
                                onClick={this.goUpdate.bind(this, food._id)}
                              ></i>
                            </a>
                          </li>
                        </>
                          ...
                          <li>
                            <a href="#">
                              <i
                                ...
                                onClick={this.book.bind(this, food._id)}
                              ></i>
                            </a>
                          </li>
                          <li>
                            <a
                              href="#"
                              onClick={this.single.bind(this, food._id)}
                            >
                              <i class="fa fa-eye"></i>
                            </a>
                          </li>
