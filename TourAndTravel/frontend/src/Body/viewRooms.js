...
export default class viewRestFood extends Component {
  ...
  deleteFood = (id) => {
    axios
      .delete("http://localhost:3000/deleteRoom/" + id + "/" + this.state.id)
      .then((response) => {
        alert("Deleted!!!");
      });
  };
  ...
  componentDidMount() {
    axios
      .get("http://localhost:3000/getHotel/" + this.state.id)
      .then((response) => {
        ...
        >
          <div className="row">
            ...
            <div className="col-md-7">
              ...
              <div className="price">
                <span className="mr-2">
                  &nbsp;Our Address: {this.state.address}
                </span>
                      ...
                      {user === "Admin" ? (
                        <>
                          <li>
                            <a
                              href="#"
                              onClick={this.deleteFood.bind(this, item._id)}
                            >
                          ...
                          <li>
                            <a href="#">
                              <i
                                class="fa fa-random"
                                onClick={this.goUpdate.bind(this, item._id)}
                              ></i>
                            </a>
                          </li>
                        </>
