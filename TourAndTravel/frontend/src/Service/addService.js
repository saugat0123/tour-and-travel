...
import React, {state, Component, fileHandler, changeHandler, addHotel} from 'react'
...
class addService extends Component {
    ...
    addHotel = (e) => {
        ...
        axios.post("http://localhost:3000/addService", data, this.state.config).then((response) => {
