...
router.get('/bookingHire', verifyUser, function (req, res) {
...
router.put('/delete/bookingHire/:oid', verifyUser, function (req, res) {
...
router.put('/updatebookingHire/:pid', verifyUser, function (req, res, next) {
...
router.put('/deleteBookingHire', verifyUser, function (req, res) {
...
router.delete('/deleteHire', verifyUser, function (req, res) {
